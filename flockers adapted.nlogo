...
to setup
  ...
  create-turtles population
    [
      ;set shape "single pixel"
      setxy random-xcor random-ycor
      set boid-size random 10
      set size boid-size * 0.33
      set color scale-color blue boid-size 0 10
...
to find-flockmates  ;; turtle procedure
  let my-boid-size boid-size
  set flockmates other turtles in-radius vision with [abs (boid-size - my-boid-size) <= SP]
end
